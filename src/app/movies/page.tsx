...
const currentMovies = [
  ...
  { title: "스파이더맨: 브랜드 뉴 데이", year: 2026, genre: "Action / Hero", rating: 9.4, image: "https://images.unsplash.com/photo-1635805737707-575885ab0820?w=800&auto=format&fit=crop&q=60", link: "https://search.naver.com/search.naver?query=%EC%98%81%ED%99%94+%EC%8A%A4%ED%8C%8C%EC%9D%B4%EB%8D%94%EB%A7%A8+%EB%B8%8C%EB%9E%9C%EB%93%9C+%EB%89%B4+%EB%8D%B0%EC%9D%B4" },
  { title: "미니언즈 & 몬스터즈", year: 2026, genre: "Animation / Comedy", rating: 8.9, image: "https://images.unsplash.com/photo-1593085512084-81335b138dcb?w=800&auto=format&fit=crop&q=60", link: "https://search.naver.com/search.naver?query=%EC%98%81%ED%99%94+%EB%AF%B8%EB%8B%88%EC%96%B8%EC%A6%88+%EB%AA%AC%EC%8A%A4%ED%84%B0%EC%A6%88" },
  { title: "모아나 (실사판)", year: 2026, genre: "Adventure / Fantasy", rating: 9.1, image: "https://images.unsplash.com/photo-1618331835717-801e976710b2?w=800&auto=format&fit=crop&q=60", link: "https://search.naver.com/search.naver?query=%EC%98%81%ED%99%94+%EB%AA%A8%EC%95%84%EB%82%98+%EC%8B%A4%EC%82%AC%ED%8C%90" },
];
